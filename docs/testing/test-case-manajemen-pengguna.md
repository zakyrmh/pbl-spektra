...
| TC-E-06   | Edit Simpan Berhasil       | ❌ FAIL | 07/06/2026  | Zaky Ramadhan | SQLSTATE[42S22]: Column not found: 1054 Unknown column 'no_telp' in 'field list' (Connection: mysql, Host: 127.0.0.1, Port: 3306, Database: pbl_spektra, SQL: update `users` set `name` = Budi Santoso, S.E., `no_telp` = ?, `users`.`updated_at` = 2026-06-07 09:07:41 where `id` = 4) |
