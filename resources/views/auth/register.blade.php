...
@section('auth_content')
    <div class="flex flex-col items-center mb-6 text-center">
        ...
        <p class="text-xl font-bold text-gray-800 mt-0.5">Selamat Datang</p>
        <p class="text-sm text-gray-500 mt-1">Silakan daftar untuk melanjutkan layanan</p>
    </div>
    ...
    <div class="w-full max-w-sm bg-white rounded-3xl shadow-xl px-7 py-8">
        ...
        {{-- Heading --}}
        <div class="mb-5">
            <h2 class="text-base font-bold text-gray-800">Buat Akun Baru</h2>
            <p class="text-xs text-gray-500 mt-1 leading-relaxed">
                Lengkapi data diri Anda untuk mengakses layanan MPP.
            </p>
        </div>
        ...
        <form action="{{ route('register.process') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    @php $nameClass = $errors->has('name') ? 'border-red-400' : 'border-gray-200'; @endphp
                    <input type="text" name="name" id="name" value="{{ old('name') }}"
                        placeholder="Masukkan nama lengkap" autofocus
                        class="w-full pl-10 pr-4 py-3 text-sm bg-gray-50 border {{ $nameClass }} rounded-xl text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                    @error('name')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation"
                        placeholder="••••••••"
                        class="w-full pl-10 pr-11 py-3 text-sm bg-gray-50 border border-gray-200 rounded-xl text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
