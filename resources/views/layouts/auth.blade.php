...
@section('base_content')
    <div class="flex flex-col lg:flex-row lg:h-screen lg:overflow-hidden">
        ...
        {{-- Kolom Kanan — Form --}}
        <div
            class="flex-1 flex flex-col items-center px-6 py-10 lg:py-12 bg-white lg:overflow-y-auto lg:h-screen">
            ...
            <div class="my-auto w-full max-w-md flex flex-col">
                ...
                <div class="flex lg:hidden flex-col items-center mb-6 text-center">
                    ...
                    <h1 class="text-xl font-extrabold text-primary">MPP Sawahlunto</h1>
                </div>
