            ...
            <tr class="hover:bg-surface-soft dark:hover:bg-white/5 transition-colors duration-150 group">
                ...
                <td class="px-5 py-4 text-right">
                    <div class="inline-flex items-center gap-3">
                        ...
                        <form action="{{ route('config.departments.destroy', $dept) }}" method="POST" class="inline-flex" onsubmit="return confirm('Apakah Anda yakin ingin menghapus Gerai ini? Semua loket dan layanan terkait akan ikut terhapus.')">
                            @csrf
                            @method('DELETE')
                            <button
                                type="submit"
